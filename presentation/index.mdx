...
- Run code
  - `actionCreator.type` has the action type
  - Returned action object has argument passed to creator as payload
...
- Example here using redux-thunk library
  - Is a middleware, but not API-call specific
  - Gives you access to store's `dispatch`
...
- Run code:
  - You get request start and success actions automatically
